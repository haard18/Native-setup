...
const FormField = (
    { title, value, placeholder, handleChangeText, otherStyles, keyBoardType, ...props }:
        { title: string, value: string, placeholder: string, handleChangeText: any, otherStyles: string, keyBoardType: string }) => {
